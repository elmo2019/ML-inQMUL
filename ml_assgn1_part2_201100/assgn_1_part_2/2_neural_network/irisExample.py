...
print("hidden_number = 1")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[0], argmin_cost+1))
print("hidden_number = 2")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[1], argmin_cost+1))
print("hidden_number = 3")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[2], argmin_cost+1))
print("hidden_number = 5")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[4], argmin_cost+1))
print("hidden_number = 7")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[6], argmin_cost+1))
print("hidden_number = 10")
print('Minimum cost: {:.5f}, on iteration #{}'.format(errors[9], argmin_cost+1))
